...
import { computeOrderPrice, type UnratedOrder } from "@/app/lib/pricing";
import {
  ...
  return (
    <div className="service-configurator relative min-h-screen font-sans">
      ...
      <div className="relative mx-auto max-w-[1280px] px-4 py-8 pt-24 sm:px-6 sm:pt-24">
        <ServiceIntro
          title="Rainbow Six Siege Unrated Matches Boost"
          description="Choose the number of unrated matches you want completed, then set your platform and preferences."
        />
          ...
          <main className="min-w-0 space-y-6">
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-5 py-4">
              ...
              <p className="mt-1 text-sm text-zinc-400">
                Choose the number of matches and review the full total before checkout.
              </p>
            </div>
              ...
              <div className="relative rounded-3xl border border-white/10 bg-black/40 p-6 overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="mb-6 flex flex-col items-start">
                    <Image src="/rainbow-six-siege-unrated-matches-boost.webp" alt="Unrated" width={56} height={56}  className="mb-0 h-14 w-14 object-contain drop-shadow-[0_0_12px_rgba(34,211,238,0.3)]" />
